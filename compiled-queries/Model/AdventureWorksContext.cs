...
namespace Performance.EFCore
{
    public class AdventureWorksContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("data source=(localdb)\\mssqllocaldb;initial catalog=AdventureWorks2014;integrated security=True;MultipleActiveResultSets=True;");
        }
